...
public class OSSClientUtil {
    ...
    private static String accessKeyId = "LTAIKTbo60TFEh18";
    private static String accessKeySecret = "b8K0J4mmwPzYLqpKv9iKIhHGg3UsWY";
    private static String bucketName = "fangda-maintain";
    ...
    public String uploadImg2Oss(MultipartFile file) throws Exception {
        ...
        try {
            ...
            throw new MaintainServiceException(e.getMessage(),"图片上传失败");
        }
    }
