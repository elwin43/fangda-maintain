...
public class JsonMapper extends ObjectMapper {
    ...
    public String toJson(Object object) {
        try {
            ...
            logger.error("write to json string error:" + object, var3);
            return null;
        }
    }
    ...
    public String toJson(Object object, Class<?> viewType) {
        try {
            ...
            logger.error("write to json string error:" + object, var4);
            return null;
        }
    }
    ...
    public <T> T fromJson(String jsonString, Class<T> clazz) {
        if (StringUtils.isEmpty(jsonString)) {
            ...
            try {
                ...
                logger.error("parse json string error:" + jsonString, var4);
                return null;
            }
        }
    }
    ...
    public <T> T fromJson(String jsonString, Class<T> clazz, Class<?> viewType) {
        if (StringUtils.isEmpty(jsonString)) {
            ...
            try {
                ...
                logger.error("parse json string error:" + jsonString, var5);
                return null;
            }
        }
    }
    ...
    public <T> T update(String jsonString, T object) {
        try {
            ...
            logger.error("update json string:" + jsonString + " to object:" + object + " error.", var4);
        } catch (IOException var5) {
            logger.error("update json string:" + jsonString + " to object:" + object + " error.", var5);
        }
